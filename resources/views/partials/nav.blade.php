<nav>
  ...
  <div class="nav-links">
    ...
    <a href="{{ route('home') }}#inscricao" class="nav-cta">Cadastre-se</a>
  </div>
...
<div class="mobile-menu" id="mobileMenu">
  ...
  <a href="{{ route('home') }}#inscricao" onclick="document.getElementById('mobileMenu').classList.remove('open')">Cadastre-se</a>
</div>
